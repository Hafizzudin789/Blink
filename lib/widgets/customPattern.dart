...
//
//
// class CustomPatternTimeline extends CustomPainter {
//   const CustomPatternTimeline({Key? key});
//
//   @override
...
//     //   ..strokeWidth = 30.0;
//     //
//     // double degToRad(num deg) => deg * (math.pi / 90.0);
//     //
//     // Path path = Path();
//     // path.moveTo(size.width / 2, size.height * 0.3); //Ax,
//     // path.arcTo(Rect.fromLTWH(size.width / 2, size.height / 2, size.width / 4, size.height / 4), degToRad(0), degToRad(90), true);
//     // // path.conicTo(size.width-20, size.height * 0.3, size.width-20, size.height * 0.4, 4);// Ay
...
//
//       Offset(startingPoint.dx + 480, startingPoint.dy +20),
//       Offset(startingPoint.dx + 480, startingPoint.dy+60),
//
//       Offset(startingPoint.dx + 520, startingPoint.dy +60),
//       Offset(startingPoint.dx + 520, startingPoint.dy+20),
//
//       Offset(startingPoint.dx + 560, startingPoint.dy +20),
//       Offset(startingPoint.dx + 560, startingPoint.dy+60),
//
//     ];
//
//     final paint1 = Paint()
