...
class MyPrePaidBills extends StatefulWidget {
  const MyPrePaidBills({super.key});

  @override
  State<MyPrePaidBills> createState() => _MyPrePaidBillsState();
}

class _MyPrePaidBillsState extends State<MyPrePaidBills> {
  @override
          ...
          child: Column(
            children: [
              const Padding(
                ...
                child: Text("Pay My Bill", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white), textAlign: TextAlign.center,),
              ),
              Expanded(
                child: Stack(
