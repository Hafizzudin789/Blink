      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            _searchBar(),
            const SizedBox(height: 16),
            _settingMenuItem(label: "Asma", iconPath: "assets/icons/bills/drop.svg"),
            _divider(),
            _settingMenuItem(label: "Associations and Organizations", iconPath: "assets/icons/bills/ayla.svg"),
            _divider(),
            _settingMenuItem(label: "AYLA", iconPath: "assets/icons/bills/asma.svg"),
            _divider(),
            _settingMenuItem(label: "Banks", iconPath: "assets/icons/bills/dollor.svg"),
            _divider(),
            _settingMenuItem(label: "Charities", iconPath: "assets/icons/bills/drop.svg"),
            _divider(),
